...
public class AppMemberUserInfoRespVO {
    ...
    @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.ruoyioffice.com/xxx.png")
    ...
    public static class Level {
        ...
        @Schema(description = "等级图标", example = "https://www.ruoyioffice.com/yudao.jpg")
        private String icon;
