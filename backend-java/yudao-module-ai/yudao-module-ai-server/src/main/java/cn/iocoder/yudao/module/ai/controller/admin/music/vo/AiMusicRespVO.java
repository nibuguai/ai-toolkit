...
public class AiMusicRespVO {
    ...
    @Schema(description = "图片地址", example = "https://www.ruoyioffice.com")
    private String imageUrl;

    @Schema(description = "音频地址", example = "https://www.ruoyioffice.com")
    private String audioUrl;

    @Schema(description = "视频地址", example = "https://www.ruoyioffice.com")
